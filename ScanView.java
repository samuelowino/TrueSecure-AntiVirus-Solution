...
public class ScanView extends JPanel{
    private static SystemScanView systemScanView;
    ...
    public ScanView() {
        ...
        systemScanView = new SystemScanView();
        ...
        systemScanView.setBounds(30, 10, 670, 280);
        ...
        systemScanView.setBackground(Color.WHITE);
        bottomSectionPane.setBackground(Color.decode("#ccccff"));
        systemScanView.setBorder( new LineBorder(Color.black));
