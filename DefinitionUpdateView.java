 ...
 * @author HACKER
 */
public class DefinitionUpdateView extends JPanel {
    private static JPanel floatLinePanel;
    ...
    public DefinitionUpdateView() {
        ...
        floatLinePanel = new JPanel(null);
        ...
        List<JLabel> floatPanelLabels = Arrays.asList(
                virusDefinitionVersionValue, virusDefinitionversionLabel, statementOneLabel,
                statementTwoLabel, definationInstallationDate, definationInstallationLabel,
                definitionLastUpdateDateLabel, definitionLastUpdateLabel, virusDefinitionVersionValue,
                virusDefinitionversionLabel, spywareDefinitionVersionValueLabel,
                spywareDefintionVersion
        );
        setFloatPanelLabelProperties(floatPanelLabels);
        ...
        floatLinePanel.setBounds(30, 10, 670, 280);
        ...
        floatLinePanel.setBackground(Color.WHITE);
        bottomSectionPane.setBackground(Color.decode("#ccccff"));
        floatLinePanel.setBorder( new LineBorder(Color.black));
        ...
        floatLinePanel.add(updateDefinitionButton);
